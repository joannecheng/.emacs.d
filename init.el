...
(custom-set-variables
 ...
 '(debug-on-error t)
 '(exec-path (quote ("/Users/joannecheng/opt/bin" "/usr/bin" "/bin" "/usr/sbin" "/sbin" "/Applications/Emacs.app/Contents/MacOS/libexec" "/Applications/Emacs.app/Contents/MacOS/bin" "/usr/local/bin")))
